...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--image_ext', type=str, default='png', help='extension of image file')
        ...
        self.parser.add_argument('--config_data', type=str, default='config_data.json', help='config data file describe folder name: label, image, instance') 
